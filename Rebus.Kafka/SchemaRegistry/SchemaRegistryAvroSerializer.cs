...
{
    public class SchemaRegistryAvroSerializer : ISerializer
    {
        ...
        public async Task<TransportMessage> Serialize(Message message)
        {
            ...
            var serializer = _serializers.GetOrAdd(type, t =>
                Activator.CreateInstance(
                    typeof(AvroSerializer<>).MakeGenericType(t),
        ...
        public async Task<Message> Deserialize(TransportMessage transportMessage)
        {
            ...
            var deserializer = _deserializers.GetOrAdd(type, t =>
                Activator.CreateInstance(
                    ...
                    _schemaRegistryClient,
                    new AvroDeserializerConfig { SubjectNameStrategy = _subjectNameStrategy },
                    null
                )
            );
